    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " >
      <div class=" img-rounded" style=" background-image:url(<?php echo $image['url']; ?>);height:460px; margin-bottom:50px">
        <div id="cta" class="col-xs-10 col-sm-10 col-md-6 col-lg-7 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 img-rounded" >
          <p class="lead">
          <h2  class="pagetitle">
            Create legal documents with supporting guidance notes
...
$args=array(
'post_type' => array('document','guidance'),
'child_of'                 => 0,
'parent'                   => '',
'orderby'                  => 'name',
'order'                    => 'ASC',
...
echo category_description( $category->term_taxonomy_id ); 
    ...
    $querystr = "SELECT $wpdb->posts.*
                  ...
                  AND ID = object_id
                  AND post_type = 'document, guidance'
...
$posts = get_posts( array( 'topic' => $category->slug, 'post_type' => array('document','guidance'),) );  
