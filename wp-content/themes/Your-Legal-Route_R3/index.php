...
<div id="content">
  <div class="container">
    <div class="row">
      <div id="main" class="col-xs-12 col-sm-9 col-md-9 col-lg-9 cf"  >
        <div class="row">
          <div class="iconbar iconbar-horizontal">
            <ul>
              ...
              <li> <a href="#fakelink" class="fui-gear"> <span class="iconbar-unread">1</span> </a> </li>
            </ul>
          </div>
        </div>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
          <header class="article-header">
            ...
            <p class="byline entry-meta vcard"> <?php printf( __( 'Posted', 'bonestheme' ).' %1$s %2$s',
