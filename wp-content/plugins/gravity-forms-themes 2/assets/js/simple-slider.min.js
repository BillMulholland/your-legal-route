...
function gravity_forms_themes_init_slider(){
	jQuery('.slider').remove();
	jQuery('.gravity_forms_themes_simple_slider').each(function(k,v){
		var slide = jQuery(v);
		slide.simpleSlider({
...
jQuery(function($){
	//gravity_forms_themes_field_callbacks.push('gravity_forms_themes_init_slider');
	gravity_forms_themes_init_slider();
	$(document).ajaxSuccess(function(e, xhr, settings) {
		if(settings.data){
			if(settings.data.search('action=save-widget') != -1 && settings.data.search('gravity_forms_themes') != -1) {
				gravity_forms_themes_init_slider();
			}
		}
	});
